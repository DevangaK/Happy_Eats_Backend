...
public class CatelogController {
    ...
    @GetMapping("/display/{Dietary}/{Cousin}/{Allergies}")
    public Iterable<CatelogModel> findProductsByrecommand(@PathVariable String Dietary,@PathVariable String Cousin,@PathVariable String Allergies){
        return catelogservice.recommand(Dietary,Cousin,Allergies);
    }
}
